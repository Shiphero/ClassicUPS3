...
from ClassicUPS3.ups import Shipment, UPSConnection
...
def test_shipment_with_reference_numbers_domestic(
...
def test_shipment_international_with_reference_numbers(
    mock_urlopen_factory, ups_connection_params, sample_addresses, sample_package
):
...
def test_shipment_with_delivery_confirmation(
    mock_urlopen_factory, ups_connection_params, sample_addresses, sample_package
):
...
def test_shipment_with_all_delivery_confirmation_types(
    mock_urlopen_factory, ups_connection_params, sample_addresses, sample_package
):
...
def test_shipment_different_shipping_services(
    mock_urlopen_factory, ups_connection_params, sample_addresses, sample_package
):
...
def test_shipment_error_handling(mock_urlopen_factory, ups_connection_params, sample_addresses, sample_package):
    ...
    conn = UPSConnection(**ups_connection_params)
    mock_urlopen_factory(response_mapping={b"ShipConfirm": "ship_error_response.xml"})
...
def test_shipment_tracking_number_property(
    mock_urlopen_factory, ups_connection_params, sample_addresses, sample_package
):
